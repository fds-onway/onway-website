...
import { TableListDefault, type TableColumn, type TableAction } from './TableListDefault';
    ...
    const columns: TableColumn<RouteListItem>[] = [
        {
            ...
            render: (image: any) => {
                return image ? (
                    <img src={image} alt="Imagem da rota" className="w-11 h-11 object-cover rounded" />
                ) : (
